...
function custom_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'League', 'Taxonomy General Name', 'esport' ),
		'singular_name'              => _x( 'League', 'Taxonomy Singular Name', 'esport' ),
		'menu_name'                  => __( 'League', 'esport' ),
	...
	$args = array(
		...
		'show_tagcloud'              => true,
		"singular_label" => "esport_league",
        'rewrite' => array('slug' => 'esport_league', 'with_front'    => false)
	);
	$object_types = apply_filters( 'esport_league', array( 'es_team' ) );
        register_taxonomy( 'es_league', $object_types, $args );
